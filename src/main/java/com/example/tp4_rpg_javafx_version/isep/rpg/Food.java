...
public class Food extends Consumable {
    ...
    public void rechargeNukaCola(int f) {
        ...
        compteurNukaCola += f;
        System.out.println("Vous recuperez " + f + " Nuka-Cola ! ");
        userDelay();}
    public void rechargeRagout(int f) {
        ...
        compteurRagout += f ;
        System.out.println("Vous recuperez " + f + " Ragout ! ");
        userDelay();}
    public void rechargeBento(int f) {
        ...
        compteurBento += f ;
        System.out.println("Vous recuperez " + f + " Bento ! ");
        userDelay();}



    public void useBento(Combattant combattant) {
        System.out.println(combattant.getName() + " utilise un Bento +" + puissanceBento + " PV et recupere de la vie");
        compteurBento -=1;
        combattant.loose(-(puissanceBento+combattant.soinBonus));
    }
    public void useNukaCola(Combattant combattant) {
        System.out.println(combattant.getName() + " utilise un NukaCola +" + puissanceNukaCola + " PV et recupere de la vie");
        compteurNukaCola -=1;
        combattant.loose(-(puissanceNukaCola+combattant.soinBonus));
    }
    public void useRagout(Combattant combattant) {
        System.out.println(combattant.getName() + " utilise un Ragout +" + puissanceRagout + " PV et recupere de la vie");
        compteurRagout -=1;
